...
public class FormulaStrengthening implements Visitor<Formula>{
	...
	public Formula visit(BooleanConstant booleanConstant) {
		...
		if (numOfAllowedStrengthenings > 0) { 	
	    	boolean mutate = (ExperimentSetting.RANDOM_GENERATOR.nextInt(strengthening_rate) == 0);
	    	if (mutate) {
	...
	public Formula visit(FOperator fOperator) {
		...
		if (numOfAllowedStrengthenings > 0) {
	    	...
	    	if (mutate) {
    			...
    			int option = ExperimentSetting.RANDOM_GENERATOR.nextInt(8);
	...
	public Formula visit(GOperator gOperator) {
		...
		if (numOfAllowedStrengthenings > 0) {
	    	...
	    	if (mutate) {
    			...
    			int option = ExperimentSetting.RANDOM_GENERATOR.nextInt(5);
