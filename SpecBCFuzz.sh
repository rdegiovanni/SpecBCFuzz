...
java -Xmx8g -Djava.library.path=/usr/local/lib -cp target/classes/.:$BASEDIR/lib/*:$BASEDIR/lib/owl-18.10-snapshot.jar:$BASEDIR/lib/commons-math3-3.6.1.jar -jar target/fuzzing-ltl-solvers-0.0.1-SNAPSHOT.jar "$@"