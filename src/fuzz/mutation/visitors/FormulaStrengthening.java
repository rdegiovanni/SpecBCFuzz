...
public class FormulaStrengthening implements Visitor<Formula>{
	...
	public FormulaStrengthening(List<String> literals, int strengthening_rate, int num_of_strengthening_to_apply, Random random) {
	...
	public Formula visit(BooleanConstant booleanConstant) {
		...
		if (numOfAllowedStrengthenings > 0) { 	
	    	boolean mutate = (this.random.nextInt(strengthening_rate) == 0);
	    	if (mutate) {
	...
	public Formula visit(FOperator fOperator) {
		...
		if (numOfAllowedStrengthenings > 0) {
	    	...
	    	if (mutate) {
    			...
    			int option = this.random.nextInt(8);
	...
	public Formula visit(GOperator gOperator) {
		...
		if (numOfAllowedStrengthenings > 0) {
	    	...
	    	if (mutate) {
    			...
    			int option = this.random.nextInt(5);
