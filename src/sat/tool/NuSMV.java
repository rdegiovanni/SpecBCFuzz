...
public class NuSMV extends LTLSolver {

	private final File inputTmp;
	private String version;
	//private final File outputTmp;

	public NuSMV(File binPath, int maxAtomicPropositions) {
	...
	public NuSMV(File binPath, int maxAtomicPropositions, String version) {
