...
//	private final int numOfInputs;
	...
	public GeneralFormulaMutator(List<String> literals, int mutation_rate, int max_num_of_mutations_to_apply, Random random) {
	    		...
	    		if (random == 0)
					...
					if (op == 0)
						...
						if (this.random.nextBoolean()) {
							if (this.random.nextBoolean() && numOfTO < 2)
