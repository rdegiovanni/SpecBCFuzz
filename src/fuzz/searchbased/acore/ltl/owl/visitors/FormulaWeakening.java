...
public class FormulaWeakening implements Visitor<Formula>{
	...
	public Formula visit(BooleanConstant booleanConstant) {
		...
		if (numOfAllowedWeakenings > 0) { 	
	    	boolean mutate = (ExperimentSetting.RANDOM_GENERATOR.nextInt(weakening_rate) == 0);
	    	if (mutate) {
	...
	public Formula visit(Literal literal) {
		...
		if (numOfAllowedWeakenings > 0) {
	    	...
	    	if (mutate) {
	    		...
	    		int option = ExperimentSetting.RANDOM_GENERATOR.nextInt(3);
	    		if (option == 0) 
	    			current = BooleanConstant.TRUE;
	    		else if (option == 1) {
	    			// weak(a) = a | b
	...
	public Formula visit(FOperator fOperator) {
		...
		if (numOfAllowedWeakenings > 0) {
	    	...
	    	if (mutate) {
    			...
    			int option = ExperimentSetting.RANDOM_GENERATOR.nextInt(6);
	...
	public Formula visit(GOperator gOperator) {
		...
		if (numOfAllowedWeakenings > 0) {
	    	...
	    	if (mutate) {
    	    	...
    	    	int option = ExperimentSetting.RANDOM_GENERATOR.nextInt(7);
    			if (option == 0) 
    				current = BooleanConstant.TRUE;
    			else if (option == 1) {
	    			// weak (G(a)) = a
	...
	public Formula visit(Conjunction conjunction) {
		...
		if (numOfAllowedWeakenings > 0) { 	
	    	...
	    	if (mutate) {
	    		...
	    		numOfAllowedWeakenings--;
	    		int option = ExperimentSetting.RANDOM_GENERATOR.nextInt(4);
	    		if (option == 0)
	    			current = BooleanConstant.TRUE;
	...
	public Formula visit(Disjunction disjunction) {
		...
		if (numOfAllowedWeakenings > 0) {
	    	...
	    	if (mutate) {
	    		// 0: TRUE 1: add disjunct 2:F
	    		numOfAllowedWeakenings--;
	    		int option = ExperimentSetting.RANDOM_GENERATOR.nextInt(2);
	    		if (option == 0) 
	    			current = BooleanConstant.TRUE;
	    		else if (option ==1){
	    			//Formula new_literal = createVariable(variables.get(Settings.RANDOM_GENERATOR.nextInt(variables.size())));
