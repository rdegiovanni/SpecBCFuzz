		...
		if (numOfAllowedMutations > 0) { 	
	    	...
	    	if (mutate) {
	    		...
	    		if (random == 0)
	    			...
	    			Formula new_literal = createVariable(variables.get(ExperimentSetting.RANDOM_GENERATOR.nextInt(variables.size())));
		...
		if (numOfAllowedMutations > 0) {
	    	...
	    	if (mutate) {
	    		...
	    		if (random == 0)
					...
					int new_variable = ExperimentSetting.RANDOM_GENERATOR.nextInt(variables.size());
					while (new_variable == literal.getAtom())
						new_variable = ExperimentSetting.RANDOM_GENERATOR.nextInt(variables.size());
		...
		if (numOfAllowedMutations > 0) {
	    	...
	    	if (mutate) {
	    		...
	    		if (random == 0)
	    			...
	    			//0:F 1:G
    				int op = ExperimentSetting.RANDOM_GENERATOR.nextInt(2);
    				if (op == 0)
		...
		if (numOfAllowedMutations > 0) { 	
	    	...
	    	if (mutate) {
	    		...
	    		if (random == 0) {
    				...
    				int op = ExperimentSetting.RANDOM_GENERATOR.nextInt(threshold);
    				if (op == 0)
